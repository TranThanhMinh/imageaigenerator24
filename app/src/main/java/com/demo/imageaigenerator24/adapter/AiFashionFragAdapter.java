...
public class AiFashionFragAdapter extends RecyclerView.Adapter<AiFashionFragAdapter.ViewHolder> {
    ...
    public AiFashionFragAdapter(List<InspirationFragItemModel> list, Context context, OnItemClickListener onItemClickListener) {
        this.itemList = list;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.demo.imageaigenerator24.adapter.AiFashionFragAdapter.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                OnItemClickListener onItemClickListener = AiFashionFragAdapter.this.clickListener;
                if (onItemClickListener != null) {
                    onItemClickListener.onItemClick(inspirationFragItemModel);
                }
            }
        });
        viewHolder.appCompatButton2.setOnClickListener(new View.OnClickListener() { // from class: com.demo.imageaigenerator24.adapter.AiFashionFragAdapter.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                AdsCommon.InterstitialAdsOnly((Activity) AiFashionFragAdapter.this.context);
                OnItemClickListener onItemClickListener = AiFashionFragAdapter.this.clickListener;
                if (onItemClickListener != null) {
                    onItemClickListener.onItemClick(inspirationFragItemModel);
                }
