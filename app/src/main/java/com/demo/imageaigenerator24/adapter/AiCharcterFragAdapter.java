...
public class AiCharcterFragAdapter extends RecyclerView.Adapter<AiCharcterFragAdapter.ViewHolder> {
    ...
    public AiCharcterFragAdapter(List<InspirationFragItemModel> list, Context context, OnItemClickListener onItemClickListener) {
        this.itemList = list;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.demo.imageaigenerator24.adapter.AiCharcterFragAdapter.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                OnItemClickListener onItemClickListener = AiCharcterFragAdapter.this.clickListener;
                if (onItemClickListener != null) {
                    onItemClickListener.onItemClick(inspirationFragItemModel);
                }
            }
        });
        viewHolder.appCompatButton2.setOnClickListener(new View.OnClickListener() { // from class: com.demo.imageaigenerator24.adapter.AiCharcterFragAdapter.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                AdsCommon.InterstitialAdsOnly((Activity) AiCharcterFragAdapter.this.context);
                OnItemClickListener onItemClickListener = AiCharcterFragAdapter.this.clickListener;
                if (onItemClickListener != null) {
                    onItemClickListener.onItemClick(inspirationFragItemModel);
                }
