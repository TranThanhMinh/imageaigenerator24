...
public class InspirationFragAdapter extends RecyclerView.Adapter<InspirationFragAdapter.ViewHolder> {
    ...
    public InspirationFragAdapter(List<InspirationFragItemModel> list, Context context, OnItemClickListener onItemClickListener) {
        this.itemList = list;
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.demo.imageaigenerator24.adapter.InspirationFragAdapter.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                OnItemClickListener onItemClickListener = InspirationFragAdapter.this.clickListener;
                if (onItemClickListener != null) {
                    onItemClickListener.onItemClick(inspirationFragItemModel);
                }
            }
        });
        viewHolder.appCompatButton2.setOnClickListener(new View.OnClickListener() { // from class: com.demo.imageaigenerator24.adapter.InspirationFragAdapter.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                AdsCommon.InterstitialAdsOnly((Activity) InspirationFragAdapter.this.context);
                OnItemClickListener onItemClickListener = InspirationFragAdapter.this.clickListener;
                if (onItemClickListener != null) {
                    onItemClickListener.onItemClick(inspirationFragItemModel);
                }
